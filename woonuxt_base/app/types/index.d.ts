...
type Product = ProductBase & SimpleProduct & VariableProduct & ExternalProduct & ProductWithAttributes & ProductTags & PwbBrands;
type Address = import('#gql').AddressFragment;
type Terms = import('#gql').TermsFragment;
type ProductTags = import('#gql').ProductTagsFragment;
type PwbBrands = import('#gql').PwbBrandsFragment;
