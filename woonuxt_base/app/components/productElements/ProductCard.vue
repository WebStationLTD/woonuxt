...
<template>
  <div class="relative group">
    <NuxtLink v-if="node.slug" :to="`/produkt/${decodeURIComponent(node.slug)}`" :title="node.name" class="relative block" prefetchOn="interaction">
    ...
    <div>
      ...
      <NuxtLink v-if="node.slug" :to="`/produkt/${decodeURIComponent(node.slug)}`" :title="node.name" prefetchOn="interaction">
